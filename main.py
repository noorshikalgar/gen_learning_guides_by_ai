...
def main():
    ...
    print("🤖 Learning Guide PDF Generation Agent v2.1 (Recursion Fixed)")
    print("=" * 70)
    ...
    # Run the generator with fixed recursion limit
